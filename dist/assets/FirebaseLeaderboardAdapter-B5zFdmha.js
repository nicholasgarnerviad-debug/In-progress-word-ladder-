import{g as Oa}from"./index-3hPJfQ8u.js";const sl=()=>{};var So={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gl{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(e=>{if(Kl(e)){const n=e.getImmediate();return`${n.library}/${n.version}`}else return null}).filter(e=>e).join(" ")}}function Kl(r){const t=r.getComponent();return(t==null?void 0:t.type)==="VERSION"}const Rs="@firebase/app",Do="0.14.12";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mr=new Map,Ih=new Map,Ps=new Map;function No(r,t){try{r.container.addComponent(t)}catch(e){$t.debug(`Component ${t.name} failed to register with FirebaseApp ${r.name}`,e)}}function gr(r){const t=r.name;if(Ps.has(t))return $t.debug(`There were multiple attempts to register component ${t}.`),!1;Ps.set(t,r);for(const e of mr.values())No(e,r);for(const e of Ih.values())No(e,r);return!0}function vh(r,t){const e=r.container.getProvider("heartbeat").getImmediate({optional:!0});return e&&e.triggerHeartbeat(),r.container.getProvider(t)}function wh(r){return r==null?!1:r.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dh=1024,Nh=30;class kh{constructor(t){this.container=t,this._heartbeatsCache=null;const e=this.container.getProvider("app").getImmediate();this._storage=new xh(e),this._heartbeatsCachePromise=this._storage.read().then(n=>(this._heartbeatsCache=n,n))}async triggerHeartbeat(){var t,e;try{const s=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),o=Oo();if(((t=this._heartbeatsCache)==null?void 0:t.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===o||this._heartbeatsCache.heartbeats.some(a=>a.date===o))return;if(this._heartbeatsCache.heartbeats.push({date:o,agent:s}),this._heartbeatsCache.heartbeats.length>Nh){const a=Mh(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(a,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(n){$t.warn(n)}}async getHeartbeatsHeader(){var t;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((t=this._heartbeatsCache)==null?void 0:t.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const e=Oo(),{heartbeatsToSend:n,unsentEntries:s}=Oh(this._heartbeatsCache.heartbeats),o=dr(JSON.stringify({version:2,heartbeats:n}));return this._heartbeatsCache.lastSentHeartbeatDate=e,s.length>0?(this._heartbeatsCache.heartbeats=s,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),o}catch(e){return $t.warn(e),""}}}function Oo(){return new Date().toISOString().substring(0,10)}function Oh(r,t=Dh){const e=[];let n=r.slice();for(const s of r){const o=e.find(a=>a.agent===s.agent);if(o){if(o.dates.push(s.date),xo(e)>t){o.dates.pop();break}}else if(e.push({agent:s.agent,dates:[s.date]}),xo(e)>t){e.pop();break}n=n.slice(1)}return{heartbeatsToSend:e,unsentEntries:n}}class xh{constructor(t){this.app=t,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return Tl()?Il().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const e=await Vh(this.app);return e!=null&&e.heartbeats?e:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(t){if(await this._canUseIndexedDBPromise){const n=await this.read();return ko(this.app,{lastSentHeartbeatDate:t.lastSentHeartbeatDate??n.lastSentHeartbeatDate,heartbeats:t.heartbeats})}else return}async add(t){if(await this._canUseIndexedDBPromise){const n=await this.read();return ko(this.app,{lastSentHeartbeatDate:t.lastSentHeartbeatDate??n.lastSentHeartbeatDate,heartbeats:[...n.heartbeats,...t.heartbeats]})}else return}}function xo(r){return dr(JSON.stringify({version:2,heartbeats:r})).length}function Mh(r){if(r.length===0)return-1;let t=0,e=r[0].date;for(let n=1;n<r.length;n++)r[n].date<e&&(e=r[n].date,t=n);return t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lh(r){gr(new An("platform-logger",t=>new Gl(t),"PRIVATE")),gr(new An("heartbeat",t=>new kh(t),"PRIVATE")),Me(Rs,Do,r),Me(Rs,Do,"esm2020"),Me("fire-js","")}Lh("");var Mo=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
...
*/var re,Ka;(function(){var r;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function t(T,g){function _(){}_.prototype=g.prototype,T.F=g.prototype,T.prototype=new _,T.prototype.constructor=T,T.D=function(I,E,w){for(var p=Array(arguments.length-2),Tt=2;Tt<arguments.length;Tt++)p[Tt-2]=arguments[Tt];return g.prototype[E].apply(I,p)}}function e(){this.blockSize=-1}function n(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}t(n,e),n.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function s(T,g,_){_||(_=0);const I=Array(16);if(typeof g=="string")for(var E=0;E<16;++E)I[E]=g.charCodeAt(_++)|g.charCodeAt(_++)<<8|g.charCodeAt(_++)<<16|g.charCodeAt(_++)<<24;else for(E=0;E<16;++E)I[E]=g[_++]|g[_++]<<8|g[_++]<<16|g[_++]<<24;g=T.g[0],_=T.g[1],E=T.g[2];let w=T.g[3],p;p=g+(w^_&(E^w))+I[0]+3614090360&4294967295,g=_+(p<<7&4294967295|p>>>25),p=w+(E^g&(_^E))+I[1]+3905402710&4294967295,w=g+(p<<12&4294967295|p>>>20),p=E+(_^w&(g^_))+I[2]+606105819&4294967295,E=w+(p<<17&4294967295|p>>>15),p=_+(g^E&(w^g))+I[3]+3250441966&4294967295,_=E+(p<<22&4294967295|p>>>10),p=g+(w^_&(E^w))+I[4]+4118548399&4294967295,g=_+(p<<7&4294967295|p>>>25),p=w+(E^g&(_^E))+I[5]+1200080426&4294967295,w=g+(p<<12&4294967295|p>>>20),p=E+(_^w&(g^_))+I[6]+2821735955&4294967295,E=w+(p<<17&4294967295|p>>>15),p=_+(g^E&(w^g))+I[7]+4249261313&4294967295,_=E+(p<<22&4294967295|p>>>10),p=g+(w^_&(E^w))+I[8]+1770035416&4294967295,g=_+(p<<7&4294967295|p>>>25),p=w+(E^g&(_^E))+I[9]+2336552879&4294967295,w=g+(p<<12&4294967295|p>>>20),p=E+(_^w&(g^_))+I[10]+4294925233&4294967295,E=w+(p<<17&4294967295|p>>>15),p=_+(g^E&(w^g))+I[11]+2304563134&4294967295,_=E+(p<<22&4294967295|p>>>10),p=g+(w^_&(E^w))+I[12]+1804603682&4294967295,g=_+(p<<7&4294967295|p>>>25),p=w+(E^g&(_^E))+I[13]+4254626195&4294967295,w=g+(p<<12&4294967295|p>>>20),p=E+(_^w&(g^_))+I[14]+2792965006&4294967295,E=w+(p<<17&4294967295|p>>>15),p=_+(g^E&(w^g))+I[15]+1236535329&4294967295,_=E+(p<<22&4294967295|p>>>10),p=g+(E^w&(_^E))+I[1]+4129170786&4294967295,g=_+(p<<5&4294967295|p>>>27),p=w+(_^E&(g^_))+I[6]+3225465664&4294967295,w=g+(p<<9&4294967295|p>>>23),p=E+(g^_&(w^g))+I[11]+643717713&4294967295,E=w+(p<<14&4294967295|p>>>18),p=_+(w^g&(E^w))+I[0]+3921069994&4294967295,_=E+(p<<20&4294967295|p>>>12),p=g+(E^w&(_^E))+I[5]+3593408605&4294967295,g=_+(p<<5&4294967295|p>>>27),p=w+(_^E&(g^_))+I[10]+38016083&4294967295,w=g+(p<<9&4294967295|p>>>23),p=E+(g^_&(w^g))+I[15]+3634488961&4294967295,E=w+(p<<14&4294967295|p>>>18),p=_+(w^g&(E^w))+I[4]+3889429448&4294967295,_=E+(p<<20&4294967295|p>>>12),p=g+(E^w&(_^E))+I[9]+568446438&4294967295,g=_+(p<<5&4294967295|p>>>27),p=w+(_^E&(g^_))+I[14]+3275163606&4294967295,w=g+(p<<9&4294967295|p>>>23),p=E+(g^_&(w^g))+I[3]+4107603335&4294967295,E=w+(p<<14&4294967295|p>>>18),p=_+(w^g&(E^w))+I[8]+1163531501&4294967295,_=E+(p<<20&4294967295|p>>>12),p=g+(E^w&(_^E))+I[13]+2850285829&4294967295,g=_+(p<<5&4294967295|p>>>27),p=w+(_^E&(g^_))+I[2]+4243563512&4294967295,w=g+(p<<9&4294967295|p>>>23),p=E+(g^_&(w^g))+I[7]+1735328473&4294967295,E=w+(p<<14&4294967295|p>>>18),p=_+(w^g&(E^w))+I[12]+2368359562&4294967295,_=E+(p<<20&4294967295|p>>>12),p=g+(_^E^w)+I[5]+4294588738&4294967295,g=_+(p<<4&4294967295|p>>>28),p=w+(g^_^E)+I[8]+2272392833&4294967295,w=g+(p<<11&4294967295|p>>>21),p=E+(w^g^_)+I[11]+1839030562&4294967295,E=w+(p<<16&4294967295|p>>>16),p=_+(E^w^g)+I[14]+4259657740&4294967295,_=E+(p<<23&4294967295|p>>>9),p=g+(_^E^w)+I[1]+2763975236&4294967295,g=_+(p<<4&4294967295|p>>>28),p=w+(g^_^E)+I[4]+1272893353&4294967295,w=g+(p<<11&4294967295|p>>>21),p=E+(w^g^_)+I[7]+4139469664&4294967295,E=w+(p<<16&4294967295|p>>>16),p=_+(E^w^g)+I[10]+3200236656&4294967295,_=E+(p<<23&4294967295|p>>>9),p=g+(_^E^w)+I[13]+681279174&4294967295,g=_+(p<<4&4294967295|p>>>28),p=w+(g^_^E)+I[0]+3936430074&4294967295,w=g+(p<<11&4294967295|p>>>21),p=E+(w^g^_)+I[3]+3572445317&4294967295,E=w+(p<<16&4294967295|p>>>16),p=_+(E^w^g)+I[6]+76029189&4294967295,_=E+(p<<23&4294967295|p>>>9),p=g+(_^E^w)+I[9]+3654602809&4294967295,g=_+(p<<4&4294967295|p>>>28),p=w+(g^_^E)+I[12]+3873151461&4294967295,w=g+(p<<11&4294967295|p>>>21),p=E+(w^g^_)+I[15]+530742520&4294967295,E=w+(p<<16&4294967295|p>>>16),p=_+(E^w^g)+I[2]+3299628645&4294967295,_=E+(p<<23&4294967295|p>>>9),p=g+(E^(_|~w))+I[0]+4096336452&4294967295,g=_+(p<<6&4294967295|p>>>26),p=w+(_^(g|~E))+I[7]+1126891415&4294967295,w=g+(p<<10&4294967295|p>>>22),p=E+(g^(w|~_))+I[14]+2878612391&4294967295,E=w+(p<<15&4294967295|p>>>17),p=_+(w^(E|~g))+I[5]+4237533241&4294967295,_=E+(p<<21&4294967295|p>>>11),p=g+(E^(_|~w))+I[12]+1700485571&4294967295,g=_+(p<<6&4294967295|p>>>26),p=w+(_^(g|~E))+I[3]+2399980690&4294967295,w=g+(p<<10&4294967295|p>>>22),p=E+(g^(w|~_))+I[10]+4293915773&4294967295,E=w+(p<<15&4294967295|p>>>17),p=_+(w^(E|~g))+I[1]+2240044497&4294967295,_=E+(p<<21&4294967295|p>>>11),p=g+(E^(_|~w))+I[8]+1873313359&4294967295,g=_+(p<<6&4294967295|p>>>26),p=w+(_^(g|~E))+I[15]+4264355552&4294967295,w=g+(p<<10&4294967295|p>>>22),p=E+(g^(w|~_))+I[6]+2734768916&4294967295,E=w+(p<<15&4294967295|p>>>17),p=_+(w^(E|~g))+I[13]+1309151649&4294967295,_=E+(p<<21&4294967295|p>>>11),p=g+(E^(_|~w))+I[4]+4149444226&4294967295,g=_+(p<<6&4294967295|p>>>26),p=w+(_^(g|~E))+I[11]+3174756917&4294967295,w=g+(p<<10&4294967295|p>>>22),p=E+(g^(w|~_))+I[2]+718787259&4294967295,E=w+(p<<15&4294967295|p>>>17),p=_+(w^(E|~g))+I[9]+3951481745&4294967295,T.g[0]=T.g[0]+g&4294967295,T.g[1]=T.g[1]+(E+(p<<21&4294967295|p>>>11))&4294967295,T.g[2]=T.g[2]+E&4294967295,T.g[3]=T.g[3]+w&4294967295}n.prototype.v=function(T,g){g===void 0&&(g=T.length);const _=g-this.blockSize,I=this.C;let E=this.h,w=0;for(;w<g;){if(E==0)for(;w<=_;)s(this,T,w),w+=this.blockSize;if(typeof T=="string"){for(;w<g;)if(I[E++]=T.charCodeAt(w++),E==this.blockSize){s(this,I),E=0;break}}else for(;w<g;)if(I[E++]=T[w++],E==this.blockSize){s(this,I),E=0;break}}this.h=E,this.o+=g},n.prototype.A=function(){var T=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);T[0]=128;for(var g=1;g<T.length-8;++g)T[g]=0;g=this.o*8;for(var _=T.length-8;_<T.length;++_)T[_]=g&255,g/=256;for(this.v(T),T=Array(16),g=0,_=0;_<4;++_)for(let I=0;I<32;I+=8)T[g++]=this.g[_]>>>I&255;return T};function o(T,g){var _=l;return Object.prototype.hasOwnProperty.call(_,T)?_[T]:_[T]=g(T)}function a(T,g){this.h=g;const _=[];let I=!0;for(let E=T.length-1;E>=0;E--){const w=T[E]|0;I&&w==g||(_[E]=w,I=!1)}this.g=_}var l={};function h(T){return-128<=T&&T<128?o(T,function(g){return new a([g|0],g<0?-1:0)}):new a([T|0],T<0?-1:0)}function d(T){if(isNaN(T)||!isFinite(T))return y;if(T<0)return D(d(-T));const g=[];let _=1;for(let I=0;T>=_;I++)g[I]=T/_|0,_*=4294967296;return new a(g,0)}function m(T,g){if(T.length==0)throw Error("number format error: empty string");if(g=g||10,g<2||36<g)throw Error("radix out of range: "+g);if(T.charAt(0)=="-")return D(m(T.substring(1),g));if(T.indexOf("-")>=0)throw Error('number format error: interior "-" character');const _=d(Math.pow(g,8));let I=y;for(let w=0;w<T.length;w+=8){var E=Math.min(8,T.length-w);const p=parseInt(T.substring(w,w+E),g);E<8?(E=d(Math.pow(g,E)),I=I.j(E).add(d(p))):(I=I.j(_),I=I.add(d(p)))}return I}var y=h(0),A=h(1),b=h(16777216);r=a.prototype,r.m=function(){if(O(this))return-D(this).m();let T=0,g=1;for(let _=0;_<this.g.length;_++){const I=this.i(_);T+=(I>=0?I:4294967296+I)*g,g*=4294967296}return T},r.toString=function(T){if(T=T||10,T<2||36<T)throw Error("radix out of range: "+T);if(N(this))return"0";if(O(this))return"-"+D(this).toString(T);const g=d(Math.pow(T,6));var _=this;let I="";for(;;){const E=Rt(_,g).g;_=W(_,E.j(g));let w=((_.g.length>0?_.g[0]:_.h)>>>0).toString(T);if(_=E,N(_))return w+I;for(;w.length<6;)w="0"+w;I=w+I}},r.i=function(T){return T<0?0:T<this.g.length?this.g[T]:this.h};function N(T){if(T.h!=0)return!1;for(let g=0;g<T.g.length;g++)if(T.g[g]!=0)return!1;return!0}function O(T){return T.h==-1}r.l=function(T){return T=W(this,T),O(T)?-1:N(T)?0:1};function D(T){const g=T.g.length,_=[];for(let I=0;I<g;I++)_[I]=~T.g[I];return new a(_,~T.h).add(A)}r.abs=function(){return O(this)?D(this):this},r.add=function(T){const g=Math.max(this.g.length,T.g.length),_=[];let I=0;for(let E=0;E<=g;E++){let w=I+(this.i(E)&65535)+(T.i(E)&65535),p=(w>>>16)+(this.i(E)>>>16)+(T.i(E)>>>16);I=p>>>16,w&=65535,p&=65535,_[E]=p<<16|w}return new a(_,_[_.length-1]&-2147483648?-1:0)};function W(T,g){return T.add(D(g))}r.j=function(T){if(N(this)||N(T))return y;if(O(this))return O(T)?D(this).j(D(T)):D(D(this).j(T));if(O(T))return D(this.j(D(T)));if(this.l(b)<0&&T.l(b)<0)return d(this.m()*T.m());const g=this.g.length+T.g.length,_=[];for(var I=0;I<2*g;I++)_[I]=0;for(I=0;I<this.g.length;I++)for(let E=0;E<T.g.length;E++){const w=this.i(I)>>>16,p=this.i(I)&65535,Tt=T.i(E)>>>16,ge=T.i(E)&65535;_[2*I+2*E]+=p*ge,G(_,2*I+2*E),_[2*I+2*E+1]+=w*ge,G(_,2*I+2*E+1),_[2*I+2*E+1]+=p*Tt,G(_,2*I+2*E+1),_[2*I+2*E+2]+=w*Tt,G(_,2*I+2*E+2)}for(T=0;T<g;T++)_[T]=_[2*T+1]<<16|_[2*T];for(T=g;T<2*g;T++)_[T]=0;return new a(_,0)};function G(T,g){for(;(T[g]&65535)!=T[g];)T[g+1]+=T[g]>>>16,T[g]&=65535,g++}function Y(T,g){this.g=T,this.h=g}function Rt(T,g){if(N(g))throw Error("division by zero");if(N(T))return new Y(y,y);if(O(T))return g=Rt(D(T),g),new Y(D(g.g),D(g.h));if(O(g))return g=Rt(T,D(g)),new Y(D(g.g),g.h);if(T.g.length>30){if(O(T)||O(g))throw Error("slowDivide_ only works with positive integers.");for(var _=A,I=g;I.l(T)<=0;)_=dt(_),I=dt(I);var E=ft(_,1),w=ft(I,1);for(I=ft(I,2),_=ft(_,2);!N(I);){var p=w.add(I);p.l(T)<=0&&(E=E.add(_),w=p),I=ft(I,1),_=ft(_,1)}return g=W(T,E.j(g)),new Y(E,g)}for(E=y;T.l(g)>=0;){for(_=Math.max(1,Math.floor(T.m()/g.m())),I=Math.ceil(Math.log(_)/Math.LN2),I=I<=48?1:Math.pow(2,I-48),w=d(_),p=w.j(g);O(p)||p.l(T)>0;)_-=I,w=d(_),p=w.j(g);N(w)&&(w=A),E=E.add(w),T=W(T,p)}return new Y(E,T)}r.B=function(T){return Rt(this,T).h},r.and=function(T){const g=Math.max(this.g.length,T.g.length),_=[];for(let I=0;I<g;I++)_[I]=this.i(I)&T.i(I);return new a(_,this.h&T.h)},r.or=function(T){const g=Math.max(this.g.length,T.g.length),_=[];for(let I=0;I<g;I++)_[I]=this.i(I)|T.i(I);return new a(_,this.h|T.h)},r.xor=function(T){const g=Math.max(this.g.length,T.g.length),_=[];for(let I=0;I<g;I++)_[I]=this.i(I)^T.i(I);return new a(_,this.h^T.h)};function dt(T){const g=T.g.length+1,_=[];for(let I=0;I<g;I++)_[I]=T.i(I)<<1|T.i(I-1)>>>31;return new a(_,T.h)}function ft(T,g){const _=g>>5;g%=32;const I=T.g.length-_,E=[];for(let w=0;w<I;w++)E[w]=g>0?T.i(w+_)>>>g|T.i(w+_+1)<<32-g:T.i(w+_);return new a(E,T.h)}n.prototype.digest=n.prototype.A,n.prototype.reset=n.prototype.u,n.prototype.update=n.prototype.v,Ka=n,a.prototype.add=a.prototype.add,a.prototype.multiply=a.prototype.j,a.prototype.modulo=a.prototype.B,a.prototype.compare=a.prototype.l,a.prototype.toNumber=a.prototype.m,a.prototype.toString=a.prototype.toString,a.prototype.getBits=a.prototype.i,a.fromNumber=d,a.fromString=m,re=a}).apply(typeof Mo<"u"?Mo:typeof self<"u"?self:typeof window<"u"?window:{});var er=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var Ha,pn,Wa,or,bs,Qa,Xa,Ja;(function(){var r,t=Object.defineProperty;function e(i){i=[typeof globalThis=="object"&&globalThis,i,typeof window=="object"&&window,typeof self=="object"&&self,typeof er=="object"&&er];for(var c=0;c<i.length;++c){var u=i[c];if(u&&u.Math==Math)return u}throw Error("Cannot find global object")}var n=e(this);function s(i,c){if(c)t:{var u=n;i=i.split(".");for(var f=0;f<i.length-1;f++){var v=i[f];if(!(v in u))break t;u=u[v]}i=i[i.length-1],f=u[i],c=c(f),c!=f&&c!=null&&t(u,i,{configurable:!0,writable:!0,value:c})}}s("Symbol.dispose",function(i){return i||Symbol("Symbol.dispose")}),s("Array.prototype.values",function(i){return i||function(){return this[Symbol.iterator]()}}),s("Object.entries",function(i){return i||function(c){var u=[],f;for(f in c)Object.prototype.hasOwnProperty.call(c,f)&&u.push([f,c[f]]);return u}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var o=o||{},a=this||self;function l(i){var c=typeof i;return c=="object"&&i!=null||c=="function"}function h(i,c,u){return i.call.apply(i.bind,arguments)}function d(i,c,u){return d=h,d.apply(null,arguments)}function m(i,c){var u=Array.prototype.slice.call(arguments,1);return function(){var f=u.slice();return f.push.apply(f,arguments),i.apply(this,f)}}function y(i,c){function u(){}u.prototype=c.prototype,i.Z=c.prototype,i.prototype=new u,i.prototype.constructor=i,i.Ob=function(f,v,R){for(var C=Array(arguments.length-2),U=2;U<arguments.length;U++)C[U-2]=arguments[U];return c.prototype[v].apply(f,C)}}var A=typeof AsyncContext<"u"&&typeof AsyncContext.Snapshot=="function"?i=>i&&AsyncContext.Snapshot.wrap(i):i=>i;function b(i){const c=i.length;if(c>0){const u=Array(c);for(let f=0;f<c;f++)u[f]=i[f];return u}return[]}function N(i,c){for(let f=1;f<arguments.length;f++){const v=arguments[f];var u=typeof v;if(u=u!="object"?u:v?Array.isArray(v)?"array":u:"null",u=="array"||u=="object"&&typeof v.length=="number"){u=i.length||0;const R=v.length||0;i.length=u+R;for(let C=0;C<R;C++)i[u+C]=v[C]}else i.push(v)}}class O{constructor(c,u){this.i=c,this.j=u,this.h=0,this.g=null}get(){let c;return this.h>0?(this.h--,c=this.g,this.g=c.next,c.next=null):c=this.i(),c}}function D(i){a.setTimeout(()=>{throw i},0)}function W(){var i=T;let c=null;return i.g&&(c=i.g,i.g=i.g.next,i.g||(i.h=null),c.next=null),c}class G{constructor(){this.h=this.g=null}add(c,u){const f=Y.get();f.set(c,u),this.h?this.h.next=f:this.g=f,this.h=f}}var Y=new O(()=>new Rt,i=>i.reset());class Rt{constructor(){this.next=this.g=this.h=null}set(c,u){this.h=c,this.g=u,this.next=null}reset(){this.next=this.g=this.h=null}}let dt,ft=!1,T=new G,g=()=>{const i=Promise.resolve(void 0);dt=()=>{i.then(_)}};function _(){for(var i;i=W();){try{i.h.call(i.g)}catch(u){D(u)}var c=Y;c.j(i),c.h<100&&(c.h++,i.next=c.g,c.g=i)}ft=!1}function I(){this.u=this.u,this.C=this.C}I.prototype.u=!1,I.prototype.dispose=function(){this.u||(this.u=!0,this.N())},I.prototype[Symbol.dispose]=function(){this.dispose()},I.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function E(i,c){this.type=i,this.g=this.target=c,this.defaultPrevented=!1}E.prototype.h=function(){this.defaultPrevented=!0};var w=function(){if(!a.addEventListener||!Object.defineProperty)return!1;var i=!1,c=Object.defineProperty({},"passive",{get:function(){i=!0}});try{const u=()=>{};a.addEventListener("test",u,c),a.removeEventListener("test",u,c)}catch{}return i}();function p(i){return/^[\s\xa0]*$/.test(i)}function Tt(i,c){E.call(this,i?i.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,i&&this.init(i,c)}y(Tt,E),Tt.prototype.init=function(i,c){const u=this.type=i.type,f=i.changedTouches&&i.changedTouches.length?i.changedTouches[0]:null;this.target=i.target||i.srcElement,this.g=c,c=i.relatedTarget,c||(u=="mouseover"?c=i.fromElement:u=="mouseout"&&(c=i.toElement)),this.relatedTarget=c,f?(this.clientX=f.clientX!==void 0?f.clientX:f.pageX,this.clientY=f.clientY!==void 0?f.clientY:f.pageY,this.screenX=f.screenX||0,this.screenY=f.screenY||0):(this.clientX=i.clientX!==void 0?i.clientX:i.pageX,this.clientY=i.clientY!==void 0?i.clientY:i.pageY,this.screenX=i.screenX||0,this.screenY=i.screenY||0),this.button=i.button,this.key=i.key||"",this.ctrlKey=i.ctrlKey,this.altKey=i.altKey,this.shiftKey=i.shiftKey,this.metaKey=i.metaKey,this.pointerId=i.pointerId||0,this.pointerType=i.pointerType,this.state=i.state,this.i=i,i.defaultPrevented&&Tt.Z.h.call(this)},Tt.prototype.h=function(){Tt.Z.h.call(this);const i=this.i;i.preventDefault?i.preventDefault():i.returnValue=!1};var ge="closure_listenable_"+(Math.random()*1e6|0),Su=0;function Pu(i,c,u,f,v){this.listener=i,this.proxy=null,this.src=c,this.type=u,this.capture=!!f,this.ha=v,this.key=++Su,this.da=this.fa=!1}function Bn(i){i.da=!0,i.listener=null,i.proxy=null,i.src=null,i.ha=null}function jn(i,c,u){for(const f in i)c.call(u,i[f],f,i)}function bu(i,c){for(const u in i)c.call(void 0,i[u],u,i)}function Ai(i){const c={};for(const u in i)c[u]=i[u];return c}const Ri="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function Si(i,c){let u,f;for(let v=1;v<arguments.length;v++){f=arguments[v];for(u in f)i[u]=f[u];for(let R=0;R<Ri.length;R++)u=Ri[R],Object.prototype.hasOwnProperty.call(f,u)&&(i[u]=f[u])}}function qn(i){this.src=i,this.g={},this.h=0}qn.prototype.add=function(i,c,u,f,v){const R=i.toString();i=this.g[R],i||(i=this.g[R]=[],this.h++);const C=Gr(i,c,f,v);return C>-1?(c=i[C],u||(c.fa=!1)):(c=new Pu(c,this.src,R,!!f,v),c.fa=u,i.push(c)),c};function zr(i,c){const u=c.type;if(u in i.g){var f=i.g[u],v=Array.prototype.indexOf.call(f,c,void 0),R;(R=v>=0)&&Array.prototype.splice.call(f,v,1),R&&(Bn(c),i.g[u].length==0&&(delete i.g[u],i.h--))}}function Gr(i,c,u,f){for(let v=0;v<i.length;++v){const R=i[v];if(!R.da&&R.listener==c&&R.capture==!!u&&R.ha==f)return v}return-1}var Kr="closure_lm_"+(Math.random()*1e6|0),Hr={};function Pi(i,c,u,f,v){if(Array.isArray(c)){for(let R=0;R<c.length;R++)Pi(i,c[R],u,f,v);return null}return u=Vi(u),i&&i[ge]?i.J(c,u,l(f)?!!f.capture:!1,v):Cu(i,c,u,!1,f,v)}function Cu(i,c,u,f,v,R){if(!c)throw Error("Invalid event type");const C=l(v)?!!v.capture:!!v;let U=Qr(i);if(U||(i[Kr]=U=new qn(i)),u=U.add(c,u,f,C,R),u.proxy)return u;if(f=Vu(),u.proxy=f,f.src=i,f.listener=u,i.addEventListener)w||(v=C),v===void 0&&(v=!1),i.addEventListener(c.toString(),f,v);else if(i.attachEvent)i.attachEvent(Ci(c.toString()),f);else if(i.addListener&&i.removeListener)i.addListener(f);else throw Error("addEventListener and attachEvent are unavailable.");return u}function Vu(){function i(u){return c.call(i.src,i.listener,u)}const c=Du;return i}function bi(i,c,u,f,v){if(Array.isArray(c))for(var R=0;R<c.length;R++)bi(i,c[R],u,f,v);else f=l(f)?!!f.capture:!!f,u=Vi(u),i&&i[ge]?(i=i.i,R=String(c).toString(),R in i.g&&(c=i.g[R],u=Gr(c,u,f,v),u>-1&&(Bn(c[u]),Array.prototype.splice.call(c,u,1),c.length==0&&(delete i.g[R],i.h--)))):i&&(i=Qr(i))&&(c=i.g[c.toString()],i=-1,c&&(i=Gr(c,u,f,v)),(u=i>-1?c[i]:null)&&Wr(u))}function Wr(i){if(typeof i!="number"&&i&&!i.da){var c=i.src;if(c&&c[ge])zr(c.i,i);else{var u=i.type,f=i.proxy;c.removeEventListener?c.removeEventListener(u,f,i.capture):c.detachEvent?c.detachEvent(Ci(u),f):c.addListener&&c.removeListener&&c.removeListener(f),(u=Qr(c))?(zr(u,i),u.h==0&&(u.src=null,c[Kr]=null)):Bn(i)}}}function Ci(i){return i in Hr?Hr[i]:Hr[i]="on"+i}function Du(i,c){if(i.da)i=!0;else{c=new Tt(c,this);const u=i.listener,f=i.ha||i.src;i.fa&&Wr(i),i=u.call(f,c)}return i}function Qr(i){return i=i[Kr],i instanceof qn?i:null}var Xr="__closure_events_fn_"+(Math.random()*1e9>>>0);function Vi(i){return typeof i=="function"?i:(i[Xr]||(i[Xr]=function(c){return i.handleEvent(c)}),i[Xr])}function mt(){I.call(this),this.i=new qn(this),this.M=this,this.G=null}y(mt,I),mt.prototype[ge]=!0,mt.prototype.removeEventListener=function(i,c,u,f){bi(this,i,c,u,f)};function yt(i,c){var u,f=i.G;if(f)for(u=[];f;f=f.G)u.push(f);if(i=i.M,f=c.type||c,typeof c=="string")c=new E(c,i);else if(c instanceof E)c.target=c.target||i;else{var v=c;c=new E(f,i),Si(c,v)}v=!0;let R,C;if(u)for(C=u.length-1;C>=0;C--)R=c.g=u[C],v=$n(R,f,!0,c)&&v;if(R=c.g=i,v=$n(R,f,!0,c)&&v,v=$n(R,f,!1,c)&&v,u)for(C=0;C<u.length;C++)R=c.g=u[C],v=$n(R,f,!1,c)&&v}mt.prototype.N=function(){if(mt.Z.N.call(this),this.i){var i=this.i;for(const c in i.g){const u=i.g[c];for(let f=0;f<u.length;f++)Bn(u[f]);delete i.g[c],i.h--}}this.G=null},mt.prototype.J=function(i,c,u,f){return this.i.add(String(i),c,!1,u,f)},mt.prototype.K=function(i,c,u,f){return this.i.add(String(i),c,!0,u,f)};function $n(i,c,u,f){if(c=i.i.g[String(c)],!c)return!0;c=c.concat();let v=!0;for(let R=0;R<c.length;++R){const C=c[R];if(C&&!C.da&&C.capture==u){const U=C.listener,st=C.ha||C.src;C.fa&&zr(i.i,C),v=U.call(st,f)!==!1&&v}}return v&&!f.defaultPrevented}function Nu(i,c){if(typeof i!="function")if(i&&typeof i.handleEvent=="function")i=d(i.handleEvent,i);else throw Error("Invalid listener argument");return Number(c)>2147483647?-1:a.setTimeout(i,c||0)}function Di(i){i.g=Nu(()=>{i.g=null,i.i&&(i.i=!1,Di(i))},i.l);const c=i.h;i.h=null,i.m.apply(null,c)}class ku extends I{constructor(c,u){super(),this.m=c,this.l=u,this.h=null,this.i=!1,this.g=null}j(c){this.h=arguments,this.g?this.i=!0:Di(this)}N(){super.N(),this.g&&(a.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Xe(i){I.call(this),this.h=i,this.g={}}y(Xe,I);var Ni=[];function ki(i){jn(i.g,function(c,u){this.g.hasOwnProperty(u)&&Wr(c)},i),i.g={}}Xe.prototype.N=function(){Xe.Z.N.call(this),ki(this)},Xe.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Jr=a.JSON.stringify,Ou=a.JSON.parse,xu=class{stringify(i){return a.JSON.stringify(i,void 0)}parse(i){return a.JSON.parse(i,void 0)}};function Oi(){}function xi(){}var Je={OPEN:"a",hb:"b",ERROR:"c",tb:"d"};function Yr(){E.call(this,"d")}y(Yr,E);function Zr(){E.call(this,"c")}y(Zr,E);var pe={},Mi=null;function zn(){return Mi=Mi||new mt}pe.Ia="serverreachability";function Li(i){E.call(this,pe.Ia,i)}y(Li,E);function Ye(i){const c=zn();yt(c,new Li(c))}pe.STAT_EVENT="statevent";function Fi(i,c){E.call(this,pe.STAT_EVENT,i),this.stat=c}y(Fi,E);function Et(i){const c=zn();yt(c,new Fi(c,i))}pe.Ja="timingevent";function Ui(i,c){E.call(this,pe.Ja,i),this.size=c}y(Ui,E);function Ze(i,c){if(typeof i!="function")throw Error("Fn must not be null and must be a function");return a.setTimeout(function(){i()},c)}function tn(){this.g=!0}tn.prototype.ua=function(){this.g=!1};function Mu(i,c,u,f,v,R){i.info(function(){if(i.g)if(R){var C="",U=R.split("&");for(let K=0;K<U.length;K++){var st=U[K].split("=");if(st.length>1){const at=st[0];st=st[1];const Vt=at.split("_");C=Vt.length>=2&&Vt[1]=="type"?C+(at+"="+st+"&"):C+(at+"=redacted&")}}}else C=null;else C=R;return"XMLHTTP REQ ("+f+") [attempt "+v+"]: "+c+`
`+u+`
`+C})}function Lu(i,c,u,f,v,R,C){i.info(function(){return"XMLHTTP RESP ("+f+") [ attempt "+v+"]: "+c+`
`+u+`
`+R+" "+C})}function be(i,c,u,f){i.info(function(){return"XMLHTTP TEXT ("+c+"): "+Uu(i,u)+(f?" "+f:"")})}function Fu(i,c){i.info(function(){return"TIMEOUT: "+c})}tn.prototype.info=function(){};function Uu(i,c){if(!i.g)return c;if(!c)return null;try{const R=JSON.parse(c);if(R){for(i=0;i<R.length;i++)if(Array.isArray(R[i])){var u=R[i];if(!(u.length<2)){var f=u[1];if(Array.isArray(f)&&!(f.length<1)){var v=f[0];if(v!="noop"&&v!="stop"&&v!="close")for(let C=1;C<f.length;C++)f[C]=""}}}}return Jr(R)}catch{return c}}var Gn={NO_ERROR:0,cb:1,qb:2,pb:3,kb:4,ob:5,rb:6,Ga:7,TIMEOUT:8,ub:9},Bi={ib:"complete",Fb:"success",ERROR:"error",Ga:"abort",xb:"ready",yb:"readystatechange",TIMEOUT:"timeout",sb:"incrementaldata",wb:"progress",lb:"downloadprogress",Nb:"uploadprogress"},ji;function ts(){}y(ts,Oi),ts.prototype.g=function(){return new XMLHttpRequest},ji=new ts;function en(i){return encodeURIComponent(String(i))}function Bu(i){var c=1;i=i.split(":");const u=[];for(;c>0&&i.length;)u.push(i.shift()),c--;return i.length&&u.push(i.join(":")),u}function Kt(i,c,u,f){this.j=i,this.i=c,this.l=u,this.S=f||1,this.V=new Xe(this),this.H=45e3,this.J=null,this.o=!1,this.u=this.B=this.A=this.M=this.F=this.T=this.D=null,this.G=[],this.g=null,this.C=0,this.m=this.v=null,this.X=-1,this.K=!1,this.P=0,this.O=null,this.W=this.L=this.U=this.R=!1,this.h=new qi}function qi(){this.i=null,this.g="",this.h=!1}var $i={},es={};function ns(i,c,u){i.M=1,i.A=Hn(Ct(c)),i.u=u,i.R=!0,zi(i,null)}function zi(i,c){i.F=Date.now(),Kn(i),i.B=Ct(i.A);var u=i.B,f=i.S;Array.isArray(f)||(f=[String(f)]),ro(u.i,"t",f),i.C=0,u=i.j.L,i.h=new qi,i.g=vo(i.j,u?c:null,!i.u),i.P>0&&(i.O=new ku(d(i.Y,i,i.g),i.P)),c=i.V,u=i.g,f=i.ba;var v="readystatechange";Array.isArray(v)||(v&&(Ni[0]=v.toString()),v=Ni);for(let R=0;R<v.length;R++){const C=Pi(u,v[R],f||c.handleEvent,!1,c.h||c);if(!C)break;c.g[C.key]=C}c=i.J?Ai(i.J):{},i.u?(i.v||(i.v="POST"),c["Content-Type"]="application/x-www-form-urlencoded",i.g.ea(i.B,i.v,i.u,c)):(i.v="GET",i.g.ea(i.B,i.v,null,c)),Ye(),Mu(i.i,i.v,i.B,i.l,i.S,i.u)}Kt.prototype.ba=function(i){i=i.target;const c=this.O;c&&Qt(i)==3?c.j():this.Y(i)},Kt.prototype.Y=function(i){try{if(i==this.g)t:{const U=Qt(this.g),st=this.g.ya(),K=this.g.ca();if(!(U<3)&&(U!=3||this.g&&(this.h.h||this.g.la()||lo(this.g)))){this.K||U!=4||st==7||(st==8||K<=0?Ye(3):Ye(2)),rs(this);var c=this.g.ca();this.X=c;var u=ju(this);if(this.o=c==200,Lu(this.i,this.v,this.B,this.l,this.S,U,c),this.o){if(this.U&&!this.L){e:{if(this.g){var f,v=this.g;if((f=v.g?v.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!p(f)){var R=f;break e}}R=null}if(i=R)be(this.i,this.l,i,"Initial handshake response via X-HTTP-Initial-Response"),this.L=!0,ss(this,i);else{this.o=!1,this.m=3,Et(12),_e(this),nn(this);break t}}if(this.R){i=!0;let at;for(;!this.K&&this.C<u.length;)if(at=qu(this,u),at==es){U==4&&(this.m=4,Et(14),i=!1),be(this.i,this.l,null,"[Incomplete Response]");break}else if(at==$i){this.m=4,Et(15),be(this.i,this.l,u,"[Invalid Chunk]"),i=!1;break}else be(this.i,this.l,at,null),ss(this,at);if(Gi(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),U!=4||u.length!=0||this.h.h||(this.m=1,Et(16),i=!1),this.o=this.o&&i,!i)be(this.i,this.l,u,"[Invalid Chunked Response]"),_e(this),nn(this);else if(u.length>0&&!this.W){this.W=!0;var C=this.j;C.g==this&&C.aa&&!C.P&&(C.j.info("Great, no buffering proxy detected. Bytes received: "+u.length),ds(C),C.P=!0,Et(11))}}else be(this.i,this.l,u,null),ss(this,u);U==4&&_e(this),this.o&&!this.K&&(U==4?yo(this.j,this):(this.o=!1,Kn(this)))}else nl(this.g),c==400&&u.indexOf("Unknown SID")>0?(this.m=3,Et(12)):(this.m=0,Et(13)),_e(this),nn(this)}}}catch{}finally{}};function ju(i){if(!Gi(i))return i.g.la();const c=lo(i.g);if(c==="")return"";let u="";const f=c.length,v=Qt(i.g)==4;if(!i.h.i){if(typeof TextDecoder>"u")return _e(i),nn(i),"";i.h.i=new a.TextDecoder}for(let R=0;R<f;R++)i.h.h=!0,u+=i.h.i.decode(c[R],{stream:!(v&&R==f-1)});return c.length=0,i.h.g+=u,i.C=0,i.h.g}function Gi(i){return i.g?i.v=="GET"&&i.M!=2&&i.j.Aa:!1}function qu(i,c){var u=i.C,f=c.indexOf(`
`,u);return f==-1?es:(u=Number(c.substring(u,f)),isNaN(u)?$i:(f+=1,f+u>c.length?es:(c=c.slice(f,f+u),i.C=f+u,c)))}Kt.prototype.cancel=function(){this.K=!0,_e(this)};function Kn(i){i.T=Date.now()+i.H,Ki(i,i.H)}function Ki(i,c){if(i.D!=null)throw Error("WatchDog timer not null");i.D=Ze(d(i.aa,i),c)}function rs(i){i.D&&(a.clearTimeout(i.D),i.D=null)}Kt.prototype.aa=function(){this.D=null;const i=Date.now();i-this.T>=0?(Fu(this.i,this.B),this.M!=2&&(Ye(),Et(17)),_e(this),this.m=2,nn(this)):Ki(this,this.T-i)};function nn(i){i.j.I==0||i.K||yo(i.j,i)}function _e(i){rs(i);var c=i.O;c&&typeof c.dispose=="function"&&c.dispose(),i.O=null,ki(i.V),i.g&&(c=i.g,i.g=null,c.abort(),c.dispose())}function ss(i,c){try{var u=i.j;if(u.I!=0&&(u.g==i||is(u.h,i))){if(!i.L&&is(u.h,i)&&u.I==3){try{var f=u.Ba.g.parse(c)}catch{f=null}if(Array.isArray(f)&&f.length==3){var v=f;if(v[0]==0){t:if(!u.v){if(u.g)if(u.g.F+3e3<i.F)Yn(u),Xn(u);else break t;hs(u),Et(18)}}else u.xa=v[1],0<u.xa-u.K&&v[2]<37500&&u.F&&u.A==0&&!u.C&&(u.C=Ze(d(u.Va,u),6e3));Qi(u.h)<=1&&u.ta&&(u.ta=void 0)}else Ee(u,11)}else if((i.L||u.g==i)&&Yn(u),!p(c))for(v=u.Ba.g.parse(c),c=0;c<v.length;c++){let K=v[c];const at=K[0];if(!(at<=u.K))if(u.K=at,K=K[1],u.I==2)if(K[0]=="c"){u.M=K[1],u.ba=K[2];const Vt=K[3];Vt!=null&&(u.ka=Vt,u.j.info("VER="+u.ka));const Te=K[4];Te!=null&&(u.za=Te,u.j.info("SVER="+u.za));const Xt=K[5];Xt!=null&&typeof Xt=="number"&&Xt>0&&(f=1.5*Xt,u.O=f,u.j.info("backChannelRequestTimeoutMs_="+f)),f=u;const Jt=i.g;if(Jt){const tr=Jt.g?Jt.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(tr){var R=f.h;R.g||tr.indexOf("spdy")==-1&&tr.indexOf("quic")==-1&&tr.indexOf("h2")==-1||(R.j=R.l,R.g=new Set,R.h&&(os(R,R.h),R.h=null))}if(f.G){const fs=Jt.g?Jt.g.getResponseHeader("X-HTTP-Session-Id"):null;fs&&(f.wa=fs,Q(f.J,f.G,fs))}}u.I=3,u.l&&u.l.ra(),u.aa&&(u.T=Date.now()-i.F,u.j.info("Handshake RTT: "+u.T+"ms")),f=u;var C=i;if(f.na=Io(f,f.L?f.ba:null,f.W),C.L){Xi(f.h,C);var U=C,st=f.O;st&&(U.H=st),U.D&&(rs(U),Kn(U)),f.g=C}else po(f);u.i.length>0&&Jn(u)}else K[0]!="stop"&&K[0]!="close"||Ee(u,7);else u.I==3&&(K[0]=="stop"||K[0]=="close"?K[0]=="stop"?Ee(u,7):ls(u):K[0]!="noop"&&u.l&&u.l.qa(K),u.A=0)}}Ye(4)}catch{}}var $u=class{constructor(i,c){this.g=i,this.map=c}};function Hi(i){this.l=i||10,a.PerformanceNavigationTiming?(i=a.performance.getEntriesByType("navigation"),i=i.length>0&&(i[0].nextHopProtocol=="hq"||i[0].nextHopProtocol=="h2")):i=!!(a.chrome&&a.chrome.loadTimes&&a.chrome.loadTimes()&&a.chrome.loadTimes().wasFetchedViaSpdy),this.j=i?this.l:1,this.g=null,this.j>1&&(this.g=new Set),this.h=null,this.i=[]}function Wi(i){return i.h?!0:i.g?i.g.size>=i.j:!1}function Qi(i){return i.h?1:i.g?i.g.size:0}function is(i,c){return i.h?i.h==c:i.g?i.g.has(c):!1}function os(i,c){i.g?i.g.add(c):i.h=c}function Xi(i,c){i.h&&i.h==c?i.h=null:i.g&&i.g.has(c)&&i.g.delete(c)}Hi.prototype.cancel=function(){if(this.i=Ji(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const i of this.g.values())i.cancel();this.g.clear()}};function Ji(i){if(i.h!=null)return i.i.concat(i.h.G);if(i.g!=null&&i.g.size!==0){let c=i.i;for(const u of i.g.values())c=c.concat(u.G);return c}return b(i.i)}var Yi=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function zu(i,c){if(i){i=i.split("&");for(let u=0;u<i.length;u++){const f=i[u].indexOf("=");let v,R=null;f>=0?(v=i[u].substring(0,f),R=i[u].substring(f+1)):v=i[u],c(v,R?decodeURIComponent(R.replace(/\+/g," ")):"")}}}function Ht(i){this.g=this.o=this.j="",this.u=null,this.m=this.h="",this.l=!1;let c;i instanceof Ht?(this.l=i.l,rn(this,i.j),this.o=i.o,this.g=i.g,sn(this,i.u),this.h=i.h,as(this,so(i.i)),this.m=i.m):i&&(c=String(i).match(Yi))?(this.l=!1,rn(this,c[1]||"",!0),this.o=on(c[2]||""),this.g=on(c[3]||"",!0),sn(this,c[4]),this.h=on(c[5]||"",!0),as(this,c[6]||"",!0),this.m=on(c[7]||"")):(this.l=!1,this.i=new cn(null,this.l))}Ht.prototype.toString=function(){const i=[];var c=this.j;c&&i.push(an(c,Zi,!0),":");var u=this.g;return(u||c=="file")&&(i.push("//"),(c=this.o)&&i.push(an(c,Zi,!0),"@"),i.push(en(u).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),u=this.u,u!=null&&i.push(":",String(u))),(u=this.h)&&(this.g&&u.charAt(0)!="/"&&i.push("/"),i.push(an(u,u.charAt(0)=="/"?Hu:Ku,!0))),(u=this.i.toString())&&i.push("?",u),(u=this.m)&&i.push("#",an(u,Qu)),i.join("")},Ht.prototype.resolve=function(i){const c=Ct(this);let u=!!i.j;u?rn(c,i.j):u=!!i.o,u?c.o=i.o:u=!!i.g,u?c.g=i.g:u=i.u!=null;var f=i.h;if(u)sn(c,i.u);else if(u=!!i.h){if(f.charAt(0)!="/")if(this.g&&!this.h)f="/"+f;else{var v=c.h.lastIndexOf("/");v!=-1&&(f=c.h.slice(0,v+1)+f)}if(v=f,v==".."||v==".")f="";else if(v.indexOf("./")!=-1||v.indexOf("/.")!=-1){f=v.lastIndexOf("/",0)==0,v=v.split("/");const R=[];for(let C=0;C<v.length;){const U=v[C++];U=="."?f&&C==v.length&&R.push(""):U==".."?((R.length>1||R.length==1&&R[0]!="")&&R.pop(),f&&C==v.length&&R.push("")):(R.push(U),f=!0)}f=R.join("/")}else f=v}return u?c.h=f:u=i.i.toString()!=="",u?as(c,so(i.i)):u=!!i.m,u&&(c.m=i.m),c};function Ct(i){return new Ht(i)}function rn(i,c,u){i.j=u?on(c,!0):c,i.j&&(i.j=i.j.replace(/:$/,""))}function sn(i,c){if(c){if(c=Number(c),isNaN(c)||c<0)throw Error("Bad port number "+c);i.u=c}else i.u=null}function as(i,c,u){c instanceof cn?(i.i=c,Xu(i.i,i.l)):(u||(c=an(c,Wu)),i.i=new cn(c,i.l))}function Q(i,c,u){i.i.set(c,u)}function Hn(i){return Q(i,"zx",Math.floor(Math.random()*2147483648).toString(36)+Math.abs(Math.floor(Math.random()*2147483648)^Date.now()).toString(36)),i}function on(i,c){return i?c?decodeURI(i.replace(/%25/g,"%2525")):decodeURIComponent(i):""}function an(i,c,u){return typeof i=="string"?(i=encodeURI(i).replace(c,Gu),u&&(i=i.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),i):null}function Gu(i){return i=i.charCodeAt(0),"%"+(i>>4&15).toString(16)+(i&15).toString(16)}var Zi=/[#\/\?@]/g,Ku=/[#\?:]/g,Hu=/[#\?]/g,Wu=/[#\?@]/g,Qu=/#/g;function cn(i,c){this.h=this.g=null,this.i=i||null,this.j=!!c}function ye(i){i.g||(i.g=new Map,i.h=0,i.i&&zu(i.i,function(c,u){i.add(decodeURIComponent(c.replace(/\+/g," ")),u)}))}r=cn.prototype,r.add=function(i,c){ye(this),this.i=null,i=Ce(this,i);let u=this.g.get(i);return u||this.g.set(i,u=[]),u.push(c),this.h+=1,this};function to(i,c){ye(i),c=Ce(i,c),i.g.has(c)&&(i.i=null,i.h-=i.g.get(c).length,i.g.delete(c))}function eo(i,c){return ye(i),c=Ce(i,c),i.g.has(c)}r.forEach=function(i,c){ye(this),this.g.forEach(function(u,f){u.forEach(function(v){i.call(c,v,f,this)},this)},this)};function no(i,c){ye(i);let u=[];if(typeof c=="string")eo(i,c)&&(u=u.concat(i.g.get(Ce(i,c))));else for(i=Array.from(i.g.values()),c=0;c<i.length;c++)u=u.concat(i[c]);return u}r.set=function(i,c){return ye(this),this.i=null,i=Ce(this,i),eo(this,i)&&(this.h-=this.g.get(i).length),this.g.set(i,[c]),this.h+=1,this},r.get=function(i,c){return i?(i=no(this,i),i.length>0?String(i[0]):c):c};function ro(i,c,u){to(i,c),u.length>0&&(i.i=null,i.g.set(Ce(i,c),b(u)),i.h+=u.length)}r.toString=function(){if(this.i)return this.i;if(!this.g)return"";const i=[],c=Array.from(this.g.keys());for(let f=0;f<c.length;f++){var u=c[f];const v=en(u);u=no(this,u);for(let R=0;R<u.length;R++){let C=v;u[R]!==""&&(C+="="+en(u[R])),i.push(C)}}return this.i=i.join("&")};function so(i){const c=new cn;return c.i=i.i,i.g&&(c.g=new Map(i.g),c.h=i.h),c}function Ce(i,c){return c=String(c),i.j&&(c=c.toLowerCase()),c}function Xu(i,c){c&&!i.j&&(ye(i),i.i=null,i.g.forEach(function(u,f){const v=f.toLowerCase();f!=v&&(to(this,f),ro(this,v,u))},i)),i.j=c}function Ju(i,c){const u=new tn;if(a.Image){const f=new Image;f.onload=m(Wt,u,"TestLoadImage: loaded",!0,c,f),f.onerror=m(Wt,u,"TestLoadImage: error",!1,c,f),f.onabort=m(Wt,u,"TestLoadImage: abort",!1,c,f),f.ontimeout=m(Wt,u,"TestLoadImage: timeout",!1,c,f),a.setTimeout(function(){f.ontimeout&&f.ontimeout()},1e4),f.src=i}else c(!1)}function Yu(i,c){const u=new tn,f=new AbortController,v=setTimeout(()=>{f.abort(),Wt(u,"TestPingServer: timeout",!1,c)},1e4);fetch(i,{signal:f.signal}).then(R=>{clearTimeout(v),R.ok?Wt(u,"TestPingServer: ok",!0,c):Wt(u,"TestPingServer: server error",!1,c)}).catch(()=>{clearTimeout(v),Wt(u,"TestPingServer: error",!1,c)})}function Wt(i,c,u,f,v){try{v&&(v.onload=null,v.onerror=null,v.onabort=null,v.ontimeout=null),f(u)}catch{}}function Zu(){this.g=new xu}function cs(i){this.i=i.Sb||null,this.h=i.ab||!1}y(cs,Oi),cs.prototype.g=function(){return new Wn(this.i,this.h)};function Wn(i,c){mt.call(this),this.H=i,this.o=c,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.A=new Headers,this.h=null,this.F="GET",this.D="",this.g=!1,this.B=this.j=this.l=null,this.v=new AbortController}y(Wn,mt),r=Wn.prototype,r.open=function(i,c){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.F=i,this.D=c,this.readyState=1,ln(this)},r.send=function(i){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");if(this.v.signal.aborted)throw this.abort(),Error("Request was aborted.");this.g=!0;const c={headers:this.A,method:this.F,credentials:this.m,cache:void 0,signal:this.v.signal};i&&(c.body=i),(this.H||a).fetch(new Request(this.D,c)).then(this.Pa.bind(this),this.ga.bind(this))},r.abort=function(){this.response=this.responseText="",this.A=new Headers,this.status=0,this.v.abort(),this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),this.readyState>=1&&this.g&&this.readyState!=4&&(this.g=!1,un(this)),this.readyState=0},r.Pa=function(i){if(this.g&&(this.l=i,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=i.headers,this.readyState=2,ln(this)),this.g&&(this.readyState=3,ln(this),this.g)))if(this.responseType==="arraybuffer")i.arrayBuffer().then(this.Na.bind(this),this.ga.bind(this));else if(typeof a.ReadableStream<"u"&&"body"in i){if(this.j=i.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.B=new TextDecoder;io(this)}else i.text().then(this.Oa.bind(this),this.ga.bind(this))};function io(i){i.j.read().then(i.Ma.bind(i)).catch(i.ga.bind(i))}r.Ma=function(i){if(this.g){if(this.o&&i.value)this.response.push(i.value);else if(!this.o){var c=i.value?i.value:new Uint8Array(0);(c=this.B.decode(c,{stream:!i.done}))&&(this.response=this.responseText+=c)}i.done?un(this):ln(this),this.readyState==3&&io(this)}},r.Oa=function(i){this.g&&(this.response=this.responseText=i,un(this))},r.Na=function(i){this.g&&(this.response=i,un(this))},r.ga=function(){this.g&&un(this)};function un(i){i.readyState=4,i.l=null,i.j=null,i.B=null,ln(i)}r.setRequestHeader=function(i,c){this.A.append(i,c)},r.getResponseHeader=function(i){return this.h&&this.h.get(i.toLowerCase())||""},r.getAllResponseHeaders=function(){if(!this.h)return"";const i=[],c=this.h.entries();for(var u=c.next();!u.done;)u=u.value,i.push(u[0]+": "+u[1]),u=c.next();return i.join(`\r
`)};function ln(i){i.onreadystatechange&&i.onreadystatechange.call(i)}Object.defineProperty(Wn.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(i){this.m=i?"include":"same-origin"}});function oo(i){let c="";return jn(i,function(u,f){c+=f,c+=":",c+=u,c+=`\r
`}),c}function us(i,c,u){t:{for(f in u){var f=!1;break t}f=!0}f||(u=oo(u),typeof i=="string"?u!=null&&en(u):Q(i,c,u))}function Z(i){mt.call(this),this.headers=new Map,this.L=i||null,this.h=!1,this.g=null,this.D="",this.o=0,this.l="",this.j=this.B=this.v=this.A=!1,this.m=null,this.F="",this.H=!1}y(Z,mt);var tl=/^https?$/i,el=["POST","PUT"];r=Z.prototype,r.Fa=function(i){this.H=i},r.ea=function(i,c,u,f){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+i);c=c?c.toUpperCase():"GET",this.D=i,this.l="",this.o=0,this.A=!1,this.h=!0,this.g=this.L?this.L.g():ji.g(),this.g.onreadystatechange=A(d(this.Ca,this));try{this.B=!0,this.g.open(c,String(i),!0),this.B=!1}catch(R){ao(this,R);return}if(i=u||"",u=new Map(this.headers),f)if(Object.getPrototypeOf(f)===Object.prototype)for(var v in f)u.set(v,f[v]);else if(typeof f.keys=="function"&&typeof f.get=="function")for(const R of f.keys())u.set(R,f.get(R));else throw Error("Unknown input type for opt_headers: "+String(f));f=Array.from(u.keys()).find(R=>R.toLowerCase()=="content-type"),v=a.FormData&&i instanceof a.FormData,!(Array.prototype.indexOf.call(el,c,void 0)>=0)||f||v||u.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[R,C]of u)this.g.setRequestHeader(R,C);this.F&&(this.g.responseType=this.F),"withCredentials"in this.g&&this.g.withCredentials!==this.H&&(this.g.withCredentials=this.H);try{this.m&&(clearTimeout(this.m),this.m=null),this.v=!0,this.g.send(i),this.v=!1}catch(R){ao(this,R)}};function ao(i,c){i.h=!1,i.g&&(i.j=!0,i.g.abort(),i.j=!1),i.l=c,i.o=5,co(i),Qn(i)}function co(i){i.A||(i.A=!0,yt(i,"complete"),yt(i,"error"))}r.abort=function(i){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.o=i||7,yt(this,"complete"),yt(this,"abort"),Qn(this))},r.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Qn(this,!0)),Z.Z.N.call(this)},r.Ca=function(){this.u||(this.B||this.v||this.j?uo(this):this.Xa())},r.Xa=function(){uo(this)};function uo(i){if(i.h&&typeof o<"u"){if(i.v&&Qt(i)==4)setTimeout(i.Ca.bind(i),0);else if(yt(i,"readystatechange"),Qt(i)==4){i.h=!1;try{const R=i.ca();t:switch(R){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var c=!0;break t;default:c=!1}var u;if(!(u=c)){var f;if(f=R===0){let C=String(i.D).match(Yi)[1]||null;!C&&a.self&&a.self.location&&(C=a.self.location.protocol.slice(0,-1)),f=!tl.test(C?C.toLowerCase():"")}u=f}if(u)yt(i,"complete"),yt(i,"success");else{i.o=6;try{var v=Qt(i)>2?i.g.statusText:""}catch{v=""}i.l=v+" ["+i.ca()+"]",co(i)}}finally{Qn(i)}}}}function Qn(i,c){if(i.g){i.m&&(clearTimeout(i.m),i.m=null);const u=i.g;i.g=null,c||yt(i,"ready");try{u.onreadystatechange=null}catch{}}}r.isActive=function(){return!!this.g};function Qt(i){return i.g?i.g.readyState:0}r.ca=function(){try{return Qt(this)>2?this.g.status:-1}catch{return-1}},r.la=function(){try{return this.g?this.g.responseText:""}catch{return""}},r.La=function(i){if(this.g){var c=this.g.responseText;return i&&c.indexOf(i)==0&&(c=c.substring(i.length)),Ou(c)}};function lo(i){try{if(!i.g)return null;if("response"in i.g)return i.g.response;switch(i.F){case"":case"text":return i.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in i.g)return i.g.mozResponseArrayBuffer}return null}catch{return null}}function nl(i){const c={};i=(i.g&&Qt(i)>=2&&i.g.getAllResponseHeaders()||"").split(`\r
`);for(let f=0;f<i.length;f++){if(p(i[f]))continue;var u=Bu(i[f]);const v=u[0];if(u=u[1],typeof u!="string")continue;u=u.trim();const R=c[v]||[];c[v]=R,R.push(u)}bu(c,function(f){return f.join(", ")})}r.ya=function(){return this.o},r.Ha=function(){return typeof this.l=="string"?this.l:String(this.l)};function hn(i,c,u){return u&&u.internalChannelParams&&u.internalChannelParams[i]||c}function ho(i){this.za=0,this.i=[],this.j=new tn,this.ba=this.na=this.J=this.W=this.g=this.wa=this.G=this.H=this.u=this.U=this.o=null,this.Ya=this.V=0,this.Sa=hn("failFast",!1,i),this.F=this.C=this.v=this.m=this.l=null,this.X=!0,this.xa=this.K=-1,this.Y=this.A=this.D=0,this.Qa=hn("baseRetryDelayMs",5e3,i),this.Za=hn("retryDelaySeedMs",1e4,i),this.Ta=hn("forwardChannelMaxRetries",2,i),this.va=hn("forwardChannelRequestTimeoutMs",2e4,i),this.ma=i&&i.xmlHttpFactory||void 0,this.Ua=i&&i.Rb||void 0,this.Aa=i&&i.useFetchStreams||!1,this.O=void 0,this.L=i&&i.supportsCrossDomainXhr||!1,this.M="",this.h=new Hi(i&&i.concurrentRequestLimit),this.Ba=new Zu,this.S=i&&i.fastHandshake||!1,this.R=i&&i.encodeInitMessageHeaders||!1,this.S&&this.R&&(this.R=!1),this.Ra=i&&i.Pb||!1,i&&i.ua&&this.j.ua(),i&&i.forceLongPolling&&(this.X=!1),this.aa=!this.S&&this.X&&i&&i.detectBufferingProxy||!1,this.ia=void 0,i&&i.longPollingTimeout&&i.longPollingTimeout>0&&(this.ia=i.longPollingTimeout),this.ta=void 0,this.T=0,this.P=!1,this.ja=this.B=null}r=ho.prototype,r.ka=8,r.I=1,r.connect=function(i,c,u,f){Et(0),this.W=i,this.H=c||{},u&&f!==void 0&&(this.H.OSID=u,this.H.OAID=f),this.F=this.X,this.J=Io(this,null,this.W),Jn(this)};function ls(i){if(fo(i),i.I==3){var c=i.V++,u=Ct(i.J);if(Q(u,"SID",i.M),Q(u,"RID",c),Q(u,"TYPE","terminate"),dn(i,u),c=new Kt(i,i.j,c),c.M=2,c.A=Hn(Ct(u)),u=!1,a.navigator&&a.navigator.sendBeacon)try{u=a.navigator.sendBeacon(c.A.toString(),"")}catch{}!u&&a.Image&&(new Image().src=c.A,u=!0),u||(c.g=vo(c.j,null),c.g.ea(c.A)),c.F=Date.now(),Kn(c)}To(i)}function Xn(i){i.g&&(ds(i),i.g.cancel(),i.g=null)}function fo(i){Xn(i),i.v&&(a.clearTimeout(i.v),i.v=null),Yn(i),i.h.cancel(),i.m&&(typeof i.m=="number"&&a.clearTimeout(i.m),i.m=null)}function Jn(i){if(!Wi(i.h)&&!i.m){i.m=!0;var c=i.Ea;dt||g(),ft||(dt(),ft=!0),T.add(c,i),i.D=0}}function rl(i,c){return Qi(i.h)>=i.h.j-(i.m?1:0)?!1:i.m?(i.i=c.G.concat(i.i),!0):i.I==1||i.I==2||i.D>=(i.Sa?0:i.Ta)?!1:(i.m=Ze(d(i.Ea,i,c),Eo(i,i.D)),i.D++,!0)}r.Ea=function(i){if(this.m)if(this.m=null,this.I==1){if(!i){this.V=Math.floor(Math.random()*1e5),i=this.V++;const v=new Kt(this,this.j,i);let R=this.o;if(this.U&&(R?(R=Ai(R),Si(R,this.U)):R=this.U),this.u!==null||this.R||(v.J=R,R=null),this.S)t:{for(var c=0,u=0;u<this.i.length;u++){e:{var f=this.i[u];if("__data__"in f.map&&(f=f.map.__data__,typeof f=="string")){f=f.length;break e}f=void 0}if(f===void 0)break;if(c+=f,c>4096){c=u;break t}if(c===4096||u===this.i.length-1){c=u+1;break t}}c=1e3}else c=1e3;c=go(this,v,c),u=Ct(this.J),Q(u,"RID",i),Q(u,"CVER",22),this.G&&Q(u,"X-HTTP-Session-Id",this.G),dn(this,u),R&&(this.R?c="headers="+en(oo(R))+"&"+c:this.u&&us(u,this.u,R)),os(this.h,v),this.Ra&&Q(u,"TYPE","init"),this.S?(Q(u,"$req",c),Q(u,"SID","null"),v.U=!0,ns(v,u,null)):ns(v,u,c),this.I=2}}else this.I==3&&(i?mo(this,i):this.i.length==0||Wi(this.h)||mo(this))};function mo(i,c){var u;c?u=c.l:u=i.V++;const f=Ct(i.J);Q(f,"SID",i.M),Q(f,"RID",u),Q(f,"AID",i.K),dn(i,f),i.u&&i.o&&us(f,i.u,i.o),u=new Kt(i,i.j,u,i.D+1),i.u===null&&(u.J=i.o),c&&(i.i=c.G.concat(i.i)),c=go(i,u,1e3),u.H=Math.round(i.va*.5)+Math.round(i.va*.5*Math.random()),os(i.h,u),ns(u,f,c)}function dn(i,c){i.H&&jn(i.H,function(u,f){Q(c,f,u)}),i.l&&jn({},function(u,f){Q(c,f,u)})}function go(i,c,u){u=Math.min(i.i.length,u);const f=i.l?d(i.l.Ka,i.l,i):null;t:{var v=i.i;let U=-1;for(;;){const st=["count="+u];U==-1?u>0?(U=v[0].g,st.push("ofs="+U)):U=0:st.push("ofs="+U);let K=!0;for(let at=0;at<u;at++){var R=v[at].g;const Vt=v[at].map;if(R-=U,R<0)U=Math.max(0,v[at].g-100),K=!1;else try{R="req"+R+"_"||"";try{var C=Vt instanceof Map?Vt:Object.entries(Vt);for(const[Te,Xt]of C){let Jt=Xt;l(Xt)&&(Jt=Jr(Xt)),st.push(R+Te+"="+encodeURIComponent(Jt))}}catch(Te){throw st.push(R+"type="+encodeURIComponent("_badmap")),Te}}catch{f&&f(Vt)}}if(K){C=st.join("&");break t}}C=void 0}return i=i.i.splice(0,u),c.G=i,C}function po(i){if(!i.g&&!i.v){i.Y=1;var c=i.Da;dt||g(),ft||(dt(),ft=!0),T.add(c,i),i.A=0}}function hs(i){return i.g||i.v||i.A>=3?!1:(i.Y++,i.v=Ze(d(i.Da,i),Eo(i,i.A)),i.A++,!0)}r.Da=function(){if(this.v=null,_o(this),this.aa&&!(this.P||this.g==null||this.T<=0)){var i=4*this.T;this.j.info("BP detection timer enabled: "+i),this.B=Ze(d(this.Wa,this),i)}},r.Wa=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.P=!0,Et(10),Xn(this),_o(this))};function ds(i){i.B!=null&&(a.clearTimeout(i.B),i.B=null)}function _o(i){i.g=new Kt(i,i.j,"rpc",i.Y),i.u===null&&(i.g.J=i.o),i.g.P=0;var c=Ct(i.na);Q(c,"RID","rpc"),Q(c,"SID",i.M),Q(c,"AID",i.K),Q(c,"CI",i.F?"0":"1"),!i.F&&i.ia&&Q(c,"TO",i.ia),Q(c,"TYPE","xmlhttp"),dn(i,c),i.u&&i.o&&us(c,i.u,i.o),i.O&&(i.g.H=i.O);var u=i.g;i=i.ba,u.M=1,u.A=Hn(Ct(c)),u.u=null,u.R=!0,zi(u,i)}r.Va=function(){this.C!=null&&(this.C=null,Xn(this),hs(this),Et(19))};function Yn(i){i.C!=null&&(a.clearTimeout(i.C),i.C=null)}function yo(i,c){var u=null;if(i.g==c){Yn(i),ds(i),i.g=null;var f=2}else if(is(i.h,c))u=c.G,Xi(i.h,c),f=1;else return;if(i.I!=0){if(c.o)if(f==1){u=c.u?c.u.length:0,c=Date.now()-c.F;var v=i.D;f=zn(),yt(f,new Ui(f,u)),Jn(i)}else po(i);else if(v=c.m,v==3||v==0&&c.X>0||!(f==1&&rl(i,c)||f==2&&hs(i)))switch(u&&u.length>0&&(c=i.h,c.i=c.i.concat(u)),v){case 1:Ee(i,5);break;case 4:Ee(i,10);break;case 3:Ee(i,6);break;default:Ee(i,2)}}}function Eo(i,c){let u=i.Qa+Math.floor(Math.random()*i.Za);return i.isActive()||(u*=2),u*c}function Ee(i,c){if(i.j.info("Error code "+c),c==2){var u=d(i.bb,i),f=i.Ua;const v=!f;f=new Ht(f||"//www.google.com/images/cleardot.gif"),a.location&&a.location.protocol=="http"||rn(f,"https"),Hn(f),v?Ju(f.toString(),u):Yu(f.toString(),u)}else Et(2);i.I=0,i.l&&i.l.pa(c),To(i),fo(i)}r.bb=function(i){i?(this.j.info("Successfully pinged google.com"),Et(2)):(this.j.info("Failed to ping google.com"),Et(1))};function To(i){if(i.I=0,i.ja=[],i.l){const c=Ji(i.h);(c.length!=0||i.i.length!=0)&&(N(i.ja,c),N(i.ja,i.i),i.h.i.length=0,b(i.i),i.i.length=0),i.l.oa()}}function Io(i,c,u){var f=u instanceof Ht?Ct(u):new Ht(u);if(f.g!="")c&&(f.g=c+"."+f.g),sn(f,f.u);else{var v=a.location;f=v.protocol,c=c?c+"."+v.hostname:v.hostname,v=+v.port;const R=new Ht(null);f&&rn(R,f),c&&(R.g=c),v&&sn(R,v),u&&(R.h=u),f=R}return u=i.G,c=i.wa,u&&c&&Q(f,u,c),Q(f,"VER",i.ka),dn(i,f),f}function vo(i,c,u){if(c&&!i.L)throw Error("Can't create secondary domain capable XhrIo object.");return c=i.Aa&&!i.ma?new Z(new cs({ab:u})):new Z(i.ma),c.Fa(i.L),c}r.isActive=function(){return!!this.l&&this.l.isActive(this)};function wo(){}r=wo.prototype,r.ra=function(){},r.qa=function(){},r.pa=function(){},r.oa=function(){},r.isActive=function(){return!0},r.Ka=function(){};function Zn(){}Zn.prototype.g=function(i,c){return new wt(i,c)};function wt(i,c){mt.call(this),this.g=new ho(c),this.l=i,this.h=c&&c.messageUrlParams||null,i=c&&c.messageHeaders||null,c&&c.clientProtocolHeaderRequired&&(i?i["X-Client-Protocol"]="webchannel":i={"X-Client-Protocol":"webchannel"}),this.g.o=i,i=c&&c.initMessageHeaders||null,c&&c.messageContentType&&(i?i["X-WebChannel-Content-Type"]=c.messageContentType:i={"X-WebChannel-Content-Type":c.messageContentType}),c&&c.sa&&(i?i["X-WebChannel-Client-Profile"]=c.sa:i={"X-WebChannel-Client-Profile":c.sa}),this.g.U=i,(i=c&&c.Qb)&&!p(i)&&(this.g.u=i),this.A=c&&c.supportsCrossDomainXhr||!1,this.v=c&&c.sendRawJson||!1,(c=c&&c.httpSessionIdParam)&&!p(c)&&(this.g.G=c,i=this.h,i!==null&&c in i&&(i=this.h,c in i&&delete i[c])),this.j=new Ve(this)}y(wt,mt),wt.prototype.m=function(){this.g.l=this.j,this.A&&(this.g.L=!0),this.g.connect(this.l,this.h||void 0)},wt.prototype.close=function(){ls(this.g)},wt.prototype.o=function(i){var c=this.g;if(typeof i=="string"){var u={};u.__data__=i,i=u}else this.v&&(u={},u.__data__=Jr(i),i=u);c.i.push(new $u(c.Ya++,i)),c.I==3&&Jn(c)},wt.prototype.N=function(){this.g.l=null,delete this.j,ls(this.g),delete this.g,wt.Z.N.call(this)};function Ao(i){Yr.call(this),i.__headers__&&(this.headers=i.__headers__,this.statusCode=i.__status__,delete i.__headers__,delete i.__status__);var c=i.__sm__;if(c){t:{for(const u in c){i=u;break t}i=void 0}(this.i=i)&&(i=this.i,c=c!==null&&i in c?c[i]:void 0),this.data=c}else this.data=i}y(Ao,Yr);function Ro(){Zr.call(this),this.status=1}y(Ro,Zr);function Ve(i){this.g=i}y(Ve,wo),Ve.prototype.ra=function(){yt(this.g,"a")},Ve.prototype.qa=function(i){yt(this.g,new Ao(i))},Ve.prototype.pa=function(i){yt(this.g,new Ro)},Ve.prototype.oa=function(){yt(this.g,"b")},Zn.prototype.createWebChannel=Zn.prototype.g,wt.prototype.send=wt.prototype.o,wt.prototype.open=wt.prototype.m,wt.prototype.close=wt.prototype.close,Ja=function(){return new Zn},Xa=function(){return zn()},Qa=pe,bs={jb:0,mb:1,nb:2,Hb:3,Mb:4,Jb:5,Kb:6,Ib:7,Gb:8,Lb:9,PROXY:10,NOPROXY:11,Eb:12,Ab:13,Bb:14,zb:15,Cb:16,Db:17,fb:18,eb:19,gb:20},Gn.NO_ERROR=0,Gn.TIMEOUT=8,Gn.HTTP_ERROR=6,or=Gn,Bi.COMPLETE="complete",Wa=Bi,xi.EventType=Je,Je.OPEN="a",Je.CLOSE="b",Je.ERROR="c",Je.MESSAGE="d",mt.prototype.listen=mt.prototype.J,pn=xi,Z.prototype.listenOnce=Z.prototype.K,Z.prototype.getLastError=Z.prototype.Ha,Z.prototype.getLastErrorCode=Z.prototype.ya,Z.prototype.getStatus=Z.prototype.ca,Z.prototype.getResponseJson=Z.prototype.La,Z.prototype.getResponseText=Z.prototype.la,Z.prototype.send=Z.prototype.ea,Z.prototype.setWithCredentials=Z.prototype.Fa,Ha=Z}).apply(typeof er<"u"?er:typeof self<"u"?self:typeof window<"u"?window:{});/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Za{constructor(t,e){this.user=e,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${t}`)}}class Uh{getToken(){return Promise.resolve(null)}invalidateToken(){}start(t,e){t.enqueueRetryable(()=>e(pt.UNAUTHENTICATED))}shutdown(){}}class Bh{constructor(t){this.token=t,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(t,e){this.changeListener=e,t.enqueueRetryable(()=>e(this.token.user))}shutdown(){this.changeListener=null}}class jh{constructor(t){this.t=t,this.currentUser=pt.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(t,e){z(this.o===void 0,42304);let n=this.i;const s=h=>this.i!==n?(n=this.i,e(h)):Promise.resolve();let o=new se;this.o=()=>{this.i++,this.currentUser=this.u(),o.resolve(),o=new se,t.enqueueRetryable(()=>s(this.currentUser))};const a=()=>{const h=o;t.enqueueRetryable(async()=>{await h.promise,await s(this.currentUser)})},l=h=>{V("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=h,this.o&&(this.auth.addAuthTokenListener(this.o),a())};this.t.onInit(h=>l(h)),setTimeout(()=>{if(!this.auth){const h=this.t.getImmediate({optional:!0});h?l(h):(V("FirebaseAuthCredentialsProvider","Auth not yet detected"),o.resolve(),o=new se)}},0),a()}getToken(){const t=this.i,e=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(e).then(n=>this.i!==t?(V("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):n?(z(typeof n.accessToken=="string",31837,{l:n}),new Za(n.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const t=this.auth&&this.auth.getUid();return z(t===null||typeof t=="string",2055,{h:t}),new pt(t)}}class qh{constructor(t,e,n){this.P=t,this.T=e,this.I=n,this.type="FirstParty",this.user=pt.FIRST_PARTY,this.R=new Map}A(){return this.I?this.I():null}get headers(){this.R.set("X-Goog-AuthUser",this.P);const t=this.A();return t&&this.R.set("Authorization",t),this.T&&this.R.set("X-Goog-Iam-Authorization-Token",this.T),this.R}}class $h{constructor(t,e,n){this.P=t,this.T=e,this.I=n}getToken(){return Promise.resolve(new qh(this.P,this.T,this.I))}start(t,e){t.enqueueRetryable(()=>e(pt.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class Lo{constructor(t){this.value=t,this.type="AppCheck",this.headers=new Map,t&&t.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class zh{constructor(t,e){this.V=e,this.forceRefresh=!1,this.appCheck=null,this.m=null,this.p=null,wh(t)&&t.settings.appCheckToken&&(this.p=t.settings.appCheckToken)}start(t,e){z(this.o===void 0,3512);const n=o=>{o.error!=null&&V("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${o.error.message}`);const a=o.token!==this.m;return this.m=o.token,V("FirebaseAppCheckTokenProvider",`Received ${a?"new":"existing"} token.`),a?e(o.token):Promise.resolve()};this.o=o=>{t.enqueueRetryable(()=>n(o))};const s=o=>{V("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=o,this.o&&this.appCheck.addTokenListener(this.o)};this.V.onInit(o=>s(o)),setTimeout(()=>{if(!this.appCheck){const o=this.V.getImmediate({optional:!0});o?s(o):V("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){if(this.p)return Promise.resolve(new Lo(this.p));const t=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(t).then(e=>e?(z(typeof e.token=="string",44558,{tokenResult:e}),this.m=e.token,new Lo(e.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Js=-1;function br(r){return r==null}function pr(r){return r===0&&1/r==-1/0}function nd(r){return typeof r=="number"&&Number.isInteger(r)&&!pr(r)&&r<=Number.MAX_SAFE_INTEGER&&r>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nc="";function rd(r){let t="";for(let e=0;e<r.length;e++)t.length>0&&(t=$o(t)),t=sd(r.get(e),t);return $o(t)}function sd(r,t){let e=t;const n=r.length;for(let s=0;s<n;s++){const o=r.charAt(s);switch(o){case"\0":e+="";break;case nc:e+="";break;default:e+=o}}return e}function $o(r){return r+nc+""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zo(r){let t=0;for(const e in r)Object.prototype.hasOwnProperty.call(r,e)&&t++;return t}function fe(r,t){for(const e in r)Object.prototype.hasOwnProperty.call(r,e)&&t(e,r[e])}function rc(r){for(const t in r)if(Object.prototype.hasOwnProperty.call(r,t))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Er{constructor(t,e){this.position=t,this.inclusive=e}}function Xo(r,t,e){let n=0;for(let s=0;s<r.position.length;s++){const o=t[s],a=r.position[s];if(o.field.isKeyField()?n=x.comparator(x.fromName(a.referenceValue),e.key):n=je(a,e.data.field(o.field)),o.dir==="desc"&&(n*=-1),n!==0)break}return n}function Jo(r,t){if(r===null)return t===null;if(t===null||r.inclusive!==t.inclusive||r.position.length!==t.position.length)return!1;for(let e=0;e<r.position.length;e++)if(!Ft(r.position[e],t.position[e]))return!1;return!0}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Td{constructor(t,e=null,n=[],s=[],o=null,a=null,l=null){this.path=t,this.collectionGroup=e,this.orderBy=n,this.filters=s,this.limit=o,this.startAt=a,this.endAt=l,this.Te=null}}function Yo(r,t=null,e=[],n=[],s=null,o=null,a=null){return new Td(r,t,e,n,s,o,a)}function ti(r){const t=F(r);if(t.Te===null){let e=t.path.canonicalString();t.collectionGroup!==null&&(e+="|cg:"+t.collectionGroup),e+="|f:",e+=t.filters.map(n=>Ns(n)).join(","),e+="|ob:",e+=t.orderBy.map(n=>function(o){return o.field.canonicalString()+o.dir}(n)).join(","),br(t.limit)||(e+="|l:",e+=t.limit),t.startAt&&(e+="|lb:",e+=t.startAt.inclusive?"b:":"a:",e+=t.startAt.position.map(n=>qe(n)).join(",")),t.endAt&&(e+="|ub:",e+=t.endAt.inclusive?"a:":"b:",e+=t.endAt.position.map(n=>qe(n)).join(",")),t.Te=e}return t.Te}function ei(r,t){if(r.limit!==t.limit||r.orderBy.length!==t.orderBy.length)return!1;for(let e=0;e<r.orderBy.length;e++)if(!hd(r.orderBy[e],t.orderBy[e]))return!1;if(r.filters.length!==t.filters.length)return!1;for(let e=0;e<r.filters.length;e++)if(!gc(r.filters[e],t.filters[e]))return!1;return r.collectionGroup===t.collectionGroup&&!!r.path.isEqual(t.path)&&!!Jo(r.startAt,t.startAt)&&Jo(r.endAt,t.endAt)}function ks(r){return x.isDocumentKey(r.path)&&r.collectionGroup===null&&r.filters.length===0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ni(r,t){if(r.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:pr(t)?"-0":t}}function wc(r){return{integerValue:""+r}}function Nd(r,t){return nd(t)?wc(t):ni(r,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Or{constructor(){this._=void 0}}function kd(r,t,e){return r instanceof Vn?function(s,o){const a={fields:{[oc]:{stringValue:ic},[cc]:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return o&&Ys(o)&&(o=Cr(o)),o&&(a.fields[ac]=o),{mapValue:a}}(e,t):r instanceof Dn?Rc(r,t):r instanceof Nn?Sc(r,t):function(s,o){const a=Ac(s,o),l=ta(a)+ta(s.Ae);return Ds(a)&&Ds(s.Ae)?wc(l):ni(s.serializer,l)}(r,t)}function Od(r,t,e){return r instanceof Dn?Rc(r,t):r instanceof Nn?Sc(r,t):e}function Ac(r,t){return r instanceof Ir?function(n){return Ds(n)||function(o){return!!o&&"doubleValue"in o}(n)}(t)?t:{integerValue:0}:null}class Vn extends Or{}class Dn extends Or{constructor(t){super(),this.elements=t}}function Rc(r,t){const e=Pc(t);for(const n of r.elements)e.some(s=>Ft(s,n))||e.push(n);return{arrayValue:{values:e}}}class Nn extends Or{constructor(t){super(),this.elements=t}}function Sc(r,t){let e=Pc(t);for(const n of r.elements)e=e.filter(s=>!Ft(s,n));return{arrayValue:{values:e}}}class Ir extends Or{constructor(t,e){super(),this.serializer=t,this.Ae=e}}function ta(r){return tt(r.integerValue||r.doubleValue)}function Pc(r){return Zs(r)&&r.arrayValue.values?r.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mf{constructor(){this.bn=new gf}addToCollectionParentIndex(t,e){return this.bn.add(e),S.resolve()}getCollectionParents(t,e){return S.resolve(this.bn.getEntries(e))}addFieldIndex(t,e){return S.resolve()}deleteFieldIndex(t,e){return S.resolve()}deleteAllFieldIndexes(t){return S.resolve()}createTargetIndexes(t,e){return S.resolve()}getDocumentsMatchingTarget(t,e){return S.resolve(null)}getIndexType(t,e){return S.resolve(0)}getFieldIndexes(t,e){return S.resolve([])}getNextCollectionGroupToUpdate(t){return S.resolve(null)}getMinOffset(t,e){return S.resolve(oe.min())}getMinOffsetFromCollectionGroup(t,e){return S.resolve(oe.min())}updateCollectionGroup(t,e,n){return S.resolve()}updateIndexEntries(t,e){return S.resolve()}}class gf{constructor(){this.index={}}add(t){const e=t.lastSegment(),n=t.popLast(),s=this.index[e]||new ot(X.comparator),o=!s.has(n);return this.index[e]=s.add(n),o}has(t){const e=t.lastSegment(),n=t.popLast(),s=this.index[e];return s&&s.has(n)}getEntries(t){return(this.index[t]||new ot(X.comparator)).toArray()}}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ua={didRun:!1,sequenceNumbersCollected:0,targetsRemoved:0,documentsRemoved:0},qc=41943040;class It{static withCacheSize(t){return new It(t,It.DEFAULT_COLLECTION_PERCENTILE,It.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT)}constructor(t,e,n){this.cacheSizeCollectionThreshold=t,this.percentileToCollect=e,this.maximumSequenceNumbersToCollect=n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ma="ConnectivityMonitor";class ga{constructor(){this.xo=()=>this.Oo(),this.No=()=>this.Bo(),this.Lo=[],this.ko()}Mo(t){this.Lo.push(t)}shutdown(){window.removeEventListener("online",this.xo),window.removeEventListener("offline",this.No)}ko(){window.addEventListener("online",this.xo),window.addEventListener("offline",this.No)}Oo(){V(ma,"Network connectivity changed: AVAILABLE");for(const t of this.Lo)t(0)}Bo(){V(ma,"Network connectivity changed: UNAVAILABLE");for(const t of this.Lo)t(1)}static v(){return typeof window<"u"&&window.addEventListener!==void 0&&window.removeEventListener!==void 0}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gt="WebChannelConnection",fn=(r,t,e)=>{r.listen(t,n=>{try{e(n)}catch(s){setTimeout(()=>{throw s},0)}})};class Le extends Kf{constructor(t){super(t),this.a_=[],this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}static u_(){if(!Le.c_){const t=Xa();fn(t,Qa.STAT_EVENT,e=>{e.stat===bs.PROXY?V(gt,"STAT_EVENT: detected buffering proxy"):e.stat===bs.NOPROXY&&V(gt,"STAT_EVENT: detected no buffering proxy")}),Le.c_=!0}}zo(t,e,n,s,o){const a=Bs();return new Promise((l,h)=>{const d=new Ha;d.setWithCredentials(!0),d.listenOnce(Wa.COMPLETE,()=>{try{switch(d.getLastErrorCode()){case or.NO_ERROR:const y=d.getResponseJson();V(gt,`XHR for RPC '${t}' ${a} received:`,JSON.stringify(y)),l(y);break;case or.TIMEOUT:V(gt,`RPC '${t}' ${a} timed out`),h(new k(P.DEADLINE_EXCEEDED,"Request time out"));break;case or.HTTP_ERROR:const A=d.getStatus();if(V(gt,`RPC '${t}' ${a} failed with status:`,A,"response text:",d.getResponseText()),A>0){let b=d.getResponseJson();Array.isArray(b)&&(b=b[0]);const N=b==null?void 0:b.error;if(N&&N.status&&N.message){const O=function(W){const G=W.toLowerCase().replace(/_/g,"-");return Object.values(P).indexOf(G)>=0?G:P.UNKNOWN}(N.status);h(new k(O,N.message))}else h(new k(P.UNKNOWN,"Server responded with status "+d.getStatus()))}else h(new k(P.UNAVAILABLE,"Connection failed."));break;default:M(9055,{l_:t,streamId:a,h_:d.getLastErrorCode(),P_:d.getLastError()})}}finally{V(gt,`RPC '${t}' ${a} completed.`)}});const m=JSON.stringify(s);V(gt,`RPC '${t}' ${a} sending request:`,s),d.send(e,"POST",m,n,15)})}T_(t,e,n){const s=Bs(),o=[this.qo,"/","google.firestore.v1.Firestore","/",t,"/channel"],a=this.createWebChannelTransport(),l={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},h=this.longPollingOptions.timeoutSeconds;h!==void 0&&(l.longPollingTimeout=Math.round(1e3*h)),this.useFetchStreams&&(l.useFetchStreams=!0),this.Go(l.initMessageHeaders,e,n),l.encodeInitMessageHeaders=!0;const d=o.join("");V(gt,`Creating RPC '${t}' stream ${s}: ${d}`,l);const m=a.createWebChannel(d,l);this.I_(m);let y=!1,A=!1;const b=new Hf({Jo:N=>{A?V(gt,`Not sending because RPC '${t}' stream ${s} is closed:`,N):(y||(V(gt,`Opening RPC '${t}' stream ${s} transport.`),m.open(),y=!0),V(gt,`RPC '${t}' stream ${s} sending:`,N),m.send(N))},Ho:()=>m.close()});return fn(m,pn.EventType.OPEN,()=>{A||(V(gt,`RPC '${t}' stream ${s} transport opened.`),b.i_())}),fn(m,pn.EventType.CLOSE,()=>{A||(A=!0,V(gt,`RPC '${t}' stream ${s} transport closed`),b.o_(),this.E_(m))}),fn(m,pn.EventType.ERROR,N=>{A||(A=!0,Re(gt,`RPC '${t}' stream ${s} transport errored. Name:`,N.name,"Message:",N.message),b.o_(new k(P.UNAVAILABLE,"The operation could not be completed")))}),fn(m,pn.EventType.MESSAGE,N=>{var O;if(!A){const D=N.data[0];z(!!D,16349);const W=D,G=(W==null?void 0:W.error)||((O=W[0])==null?void 0:O.error);if(G){V(gt,`RPC '${t}' stream ${s} received error:`,G);const Y=G.status;let Rt=function(T){const g=nt[T];if(g!==void 0)return Dc(g)}(Y),dt=G.message;Y==="NOT_FOUND"&&dt.includes("database")&&dt.includes("does not exist")&&dt.includes(this.databaseId.database)&&Re(`Database '${this.databaseId.database}' not found. Please check your project configuration.`),Rt===void 0&&(Rt=P.INTERNAL,dt="Unknown error status: "+Y+" with message "+G.message),A=!0,b.o_(new k(Rt,dt)),m.close()}else V(gt,`RPC '${t}' stream ${s} received:`,D),b.__(D)}}),Le.u_(),setTimeout(()=>{b.s_()},0),b}terminate(){this.a_.forEach(t=>t.close()),this.a_=[]}I_(t){this.a_.push(t)}E_(t){this.a_=this.a_.filter(e=>e===t)}Go(t,e,n){super.Go(t,e,n),this.databaseInfo.apiKey&&(t["x-goog-api-key"]=this.databaseInfo.apiKey)}createWebChannelTransport(){return Ja()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jm="ComponentProvider",Aa=new Map;function qm(r,t,e,n,s){return new od(r,t,e,s.host,s.ssl,s.experimentalForceLongPolling,s.experimentalAutoDetectLongPolling,fu(s.experimentalLongPollingOptions),s.useFetchStreams,s.isUsingEmulator,n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vu extends tg{constructor(t){super(),this.firestore=t}convertBytes(t){return new Pt(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new et(this.firestore,null,e)}}function eg(){return new vi("serverTimestamp")}const Va="@firebase/firestore",Da="4.14.1";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Na(r){return function(e,n){if(typeof e!="object"||e===null)return!1;const s=e;for(const o of n)if(o in s&&typeof s[o]=="function")return!0;return!1}(r,["next","error","complete"])}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function og(r){r=kt(r,et);const t=kt(r.firestore,ze),e=Ei(t);return Um(e,r._key).then(n=>Ru(t,r,n))}function ag(r,t,e){r=kt(r,et);const n=kt(r.firestore,ze),s=sg(r.converter,t),o=_u(n);return Au(n,[Xm(o,"setDoc",r._key,s,r.converter!==null,e).toMutation(r._key,xt.none())])}function ka(r,t,e,...n){r=kt(r,et);const s=kt(r.firestore,ze),o=_u(s);let a;return a=typeof(t=qt(t))=="string"||t instanceof Ti?Ym(o,"updateDoc",r._key,t,e,n):Jm(o,"updateDoc",r._key,t),Au(s,[a.toMutation(r._key,xt.exists(!0))])}function cg(r,...t){var d,m,y;r=qt(r);let e={includeMetadataChanges:!1,source:"default"},n=0;typeof t[n]!="object"||Na(t[n])||(e=t[n++]);const s={includeMetadataChanges:e.includeMetadataChanges,source:e.source};if(Na(t[n])){const A=t[n];t[n]=(d=A.next)==null?void 0:d.bind(A),t[n+1]=(m=A.error)==null?void 0:m.bind(A),t[n+2]=(y=A.complete)==null?void 0:y.bind(A)}let o,a,l;if(r instanceof et)a=kt(r.firestore,ze),l=Dr(r._key.path),o={next:A=>{t[n]&&t[n](Ru(a,r,A))},error:t[n+1],complete:t[n+2]};else{const A=kt(r,Br);a=kt(A.firestore,ze),l=A._query;const b=new vu(a);o={next:N=>{t[n]&&t[n](new Ue(a,b,A,N))},error:t[n+1],complete:t[n+2]},rg(r._query)}const h=Ei(a);return Fm(h,l,s,o)}function Au(r,t){const e=Ei(r);return Bm(e,t)}function Ru(r,t,e){const n=e.docs.get(t._key),s=new vu(r);return new we(r,s,t._key,n,new En(e.hasPendingWrites,e.fromCache),t.converter)}(function(t,e=!0){Fh(Sh),gr(new An("firestore",(n,{instanceIdentifier:s,options:o})=>{const a=n.getProvider("app").getImmediate(),l=new ze(new jh(n.getProvider("auth-internal")),new zh(a,n.getProvider("app-check-internal")),ad(a,s),a);return o={useFetchStreams:e,...o},l._setSettings(o),l},"PUBLIC").setMultipleInstances(!0)),Me(Va,Da,t),Me(Va,Da,"esm2020")})();var ug="firebase",lg="12.13.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
